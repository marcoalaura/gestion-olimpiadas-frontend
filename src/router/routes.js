...
const routes = [
  ...
  },
  {
    ...
    component: () => import(/* webpackChunkName: "examenOffline" */ '../components/examenOffline')
  },
  {
    path: '/clasificados',
    name: 'Clasificados',
  ...
  {
    path: '/reprogramacion-rezagados',
    name: 'reprogramacion-rezagados',
    component: () => import(/* webpackChunkName: "reprogramacionRezagados" */ '../components/reprogramacion-rezagados')
  },
  {
    path: '/impugnacion',
    name: 'Impugnación de preguntas',
    component: () => import(/* webpackChunkName: "impugnacion" */ '../components/impugnacion')
  },
  {
    path: '/reportes',
    name: 'Reportes',
    component: () => import(/* webpackChunkName: "impugnacion" */ '../components/reportes')
  },
  {
    path: '*',
    redirect: '/home'
